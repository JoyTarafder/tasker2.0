...
export default function AddTaskModal({ onSave, editTask, onCloseClick }) {
  ...
  return (
   <>
   <div className="bg-black opacity-70 absolute z-10 h-full w-full top-0 left-0"></div>
    <form className="mx-auto my-10 w-full max-w-[740px] rounded-xl border border-[#FEFBFB]/[36%] bg-[#191D26] p-9 max-md:px-4 lg:my-20 lg:p-11 z-10 absolute top-1/4 left-1/3">
      ...
      <div className="mt-16 flex justify-center lg:mt-20 gap-x-6">
        <button
          type="submit"
          className="rounded bg-blue-600 px-4 py-2 text-white transition-all hover:opacity-80"
          onClick={() => onSave(task , isAdding)}
        >
